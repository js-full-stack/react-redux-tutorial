...
- [Логин пользователя](#Логинизация-пользователя)
...
### Реализация отклика интерфейса при регистрации и логине
